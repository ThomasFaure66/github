namespace DileptonRates2{
    
    // NON-EQUILIBIRIUM CURRENT-CURRENT CORRELATION FUNCTION -- yQ IS PSEUDORPAIDITY OF DILEPTON PAIR //
    double SampleTracePi(double Q,double q0,double qT,double PhiQ, double yQ,double EtaX,double Xi,double Teff,double qSupp){
        ...
        return Nc*Q*Q/(4.0*M_PI*M_PI*qAbs)*Jacobian*fp*fqMp;
    ...
    void SampledNdQdy(double QSqr,double qTMin,double qTMax,double TauMin,double TauMax,double EtaQ,double dNchdEta,double Area,double etas,double &dN,double &dNPreEq,double &dNHydro){
        ...
        double dNlld4xd4Q=PreFactor*SampleTracePi(Q,q0,qT,PhiQ,yQ,EtaX,Xi,Teff,qSupp);
