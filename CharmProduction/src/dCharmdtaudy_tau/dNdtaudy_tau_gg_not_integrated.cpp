...
int main(int argc, char* argv[]) {
 ...
 // COLLISION PARAMETERS //
    ...
    std::cerr << "#KINEMATIC CUTS ARE qT=" << qTMin << " - " << qTMax << "GeV tau=" << TauMin << "-" << TauMax << " fm" << std::endl;
    ...
    // WRITE HEADER //
    std::cout << "#1--Tau [fm/c] #2--dN_{tot}/dtaudy [c/fm] #3--dN_{PreEq}/dtaudy [c/fm] #4--dN_{Hydro}/dtaudy [c/fm]" << std::endl;
