...
namespace CharmRates_gg{
    ...
    void SampleTracePi(double Q, double q0,double qT,double PhiQ, double yQ,double EtaX,double Xi,double Teff,double qSupp,double MQ, double alphas, double &sampletrace){
    ...
    void SampledNdQdy(double QSqr,double qTMin,double qTMax,double TauMin,double TauMax,double EtaQ,double dNchdEta,double Area,double etas,double MQ, double alphas, double &dN,double &dNPreEq,double &dNHydro){
        ...
        double sampletrace;
        SampleTracePi(Q,q0,qT,PhiQ,yQ,EtaX,Xi,Teff,qSupp,MQ,alphas,sampletrace);
    ...
    void SampledNdy(double QMin,double QMax,double qTMin,double qTMax,double TauMin,double TauMax,double EtaQ,double dNchdEta,double Area,double etas, double MQ, double alphas, double &dN,double &dNPreEq,double &dNHydro){
    ...
    void SampledNdy_tau(double QMin,double QMax,double qTMin,double qTMax,double TauMin, double TauMax,double EtaQ,double dNchdEta,double Area,double etas, double MQ, double alphas, double &dN,double &dNPreEq,double &dNHydro){
        ...
        Jacobian*=Tau*Area*(TauMax-TauMin)/(M_HBARC*M_HBARC*M_HBARC*M_HBARC);
