...
int main(int argc, char* argv[]) {
    ...
    //	cout << "Q : " << Q << endl;
            ...
            for(int i=0;i<NSamples;i++){
                ...
                CharmRates_qq::SampledNdQdy(Q*Q,qTMin,qTMax,TauMin,TauMax,yQ,dNchdEta,Area,EtaOverS,dN,dNPreEq,dNHydro, test);
            ...
            std::cout << Q  << " " << testo << " " << dNlldQdY << " " << dNlldQdYPreEq << " " << dNlldQdYHydro ;
