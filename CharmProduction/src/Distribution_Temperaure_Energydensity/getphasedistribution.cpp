...
namespace getphasedistribution{
    ...
    void SampleTracePi(double Q, double q0,double qT,double PhiQ, double yQ,double EtaX,double Xi,double Teff,double qSupp, double alphas,double &fgluon, double &fquark){
    ...
    void phasedistribution(double Q, double qT, double Tau ,double EtaQ,double dNchdEta,double Area,double etas, double alphas, double &fg, double &fq, double &temperature, double &energy){
        ...
        double fgluon, fquark;
        SampleTracePi(Q,q0,qT,PhiQ,yQ,EtaQ,Xi,Teff,qSupp,alphas,fgluon, fquark);
