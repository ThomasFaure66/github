...
//        	CosThetaPQ = 1.0;}
    ...
    void phasedistribution(double Q, double qT, double Tau ,double EtaQ,double dNchdEta,double Area,double etas, double MQ, double alphas, double &fg,double &fq, double &energy){
    ...
    void SampledNdydtau_tau(double QMin,double QMax,double qTMin,double qTMax,double Tau,double EtaQ,double dNchdEta,double Area,double etas, double MQ, double alphas, double &dN,double &dNPreEq,double &dNHydro){
