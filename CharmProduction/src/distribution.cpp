...
int main(int argc, char* argv[]) {
 ...
 // COLLISION PARAMETERS //
    ...
    double qT=5; double TauMin=0.0; double TauMax=0.05;
  ...
  // CALCULATE DILEPTON PRODUCTION -- dN/dQdyQ //
    ...
    //	cout << "Q : " << Q << endl;
            ...
            for(int i=0;i<NSamples;i++){
                ...
                double fg,fq, energy;
                getphasedistribution::phasedistribution(Q,qT,Tau,yQ,dNchdEta,Area,EtaOverS,MQ,alphas,fg,fq, energy);
                d1+=fg; d2+=fq; d3+=energy;
