...
int main(){
      ...
      char filexsec1[6000];
      sprintf(filexsec1,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/Charmproduction_FONLL_sym.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      while(j1<40){
 	      y[j1] = all1[j1*2];
 	      zerocinq[j1]=all1[j1*2+1];
 	      j1++;
	      }
	      
      char filexsec2[6000];
      sprintf(filexsec2,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/5_10.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      while(j2<40){
 	      cinqdix[j2]=all2[j2*2+1];
 	      j2++;
	      }
	      

      char filexsec3[6000];
      sprintf(filexsec3,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/10_20.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      while(j3<40){
 	      dixvingt[j3]=all3[j3*2+1];
 	      j3++;
	      }

      char filexsec4[6000];
      sprintf(filexsec4,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/20_30.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      while(j4<40){
 	      vingttrente[j4]=all4[j4*2+1];
 	      j4++;
	      }
	      
      char filexsec5[6000];
      sprintf(filexsec5,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/30_40.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      while(j5<40){
 	      trentequarante[j5]=all5[j5*2+1];
 	      j5++;
	      }

      char filexsec6[6000];
      sprintf(filexsec6,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/40_50.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      char filexsec7[6000];
      sprintf(filexsec7,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/50_60.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      char filexsec8[6000];
      sprintf(filexsec8,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/60_70.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      char filexsec9[6000];
      sprintf(filexsec9,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/70_80.txt");
     ...
     for(int i = 0; i<600; i++){
      ...
      char filexsec[6000];
      sprintf(filexsec,"/local/home/tf275865/Bureau/Stage_code/CharmProduction/results/Charm_production_fromFONLL/80_90.txt");
