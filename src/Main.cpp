...
//	cout << "Q : " << Q << endl;
        ...
        for(int i=0;i<NSamples;i++){
            ...
            DileptonRates::SampleqT(QMin,QMax,qT,TauMin,TauMax,yQ,dNchdEta,Area,EtaOverS,dN,dNPreEq,dNHydro);
...
//
//
//        std::cout << qT << " " << Q << " " << dNlldQdY << " " << dNlldQdYPreEq << " " << dNlldQdYHydro << std::endl;
//
//    }
//   
